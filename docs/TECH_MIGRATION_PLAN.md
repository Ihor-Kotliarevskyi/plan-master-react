...
- module-based UI islands now exist for the user cabinet, auth-only cabinet flows, audit viewer, share modal, project settings, project manager, app shell, overdue banner, gantt surface, print dialog shell, print preview surface, print chart picker, chart edit dialog, chart surface, task modal shell, cost editor, notes modal, dependency list modal, contractor entry modal, contractor detail and register surface, contractor dialog flows, payment register modal, contractor tools menu, contractor import/review shell, finance chart controls, and finance surface
